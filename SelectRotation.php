...
<body style="background-color: lightblue;">
    ...
    <form action=ShowRotation.php method="get">
        ...
        <input type="submit" name="Rotations" value="One" style="width: 20em;  height: 2em;">
        <br>
        <input type="submit" name="Rotations" value="All"  style="width: 20em;  height: 2em;">
    </form>
</body>
</html>
